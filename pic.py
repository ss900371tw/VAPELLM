        ...
        if "403" in str(e):
            ...
            try:
                with sync_playwright() as p:
                    ...
                    return body_text[random.randint(0, max(len(body_text) - 200, 0)) :][:200]
...
b.電子煙品牌與標誌
常見商標（如 JUUL、RELX、MYLE 等）、文字標誌、LOGO。

c.吸煙或霧氣效果
可見煙霧、蒸氣、霧氣擴散等視覺效果。

d.電子菸文化相關元素
如 vape 集會、煙圈秀（O-rings）、電子菸相關塗鴉及標語、電子菸元素印花等。

e.推廣行銷內容
如電子菸促銷標語、價格、購買連結、優惠碼、購物車按鈕等。
